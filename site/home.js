    ...
    root.innerHTML =
      '<div class="showcase" style="border:1px solid ' + p.tint + '">' +
        ...
        '<div class="showcase-body">' +
          (p.shot
            ? (p.site
                ? '<a class="showcase-shot' + (p.fit === 'contain' ? ' showcase-shot--contain' : '') + '" href="' + p.site + '" target="_blank" rel="noopener" title="Visit ' + p.name + '">'
                : '<div class="showcase-shot' + (p.fit === 'contain' ? ' showcase-shot--contain' : '') + '">') +
